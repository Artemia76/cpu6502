...
public:
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] = 
			...
			opcode(Ins::ADC_ABS) : opcode(Ins::SBC_ABS);
		mem[0xFF01] = 0x00;
		mem[0xFF02] = 0x80;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] =
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_ABSX) : opcode(Ins::SBC_ABSX);
		mem[0xFF01] = 0x00;
		mem[0xFF02] = 0x80;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] =
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_ABSY) :opcode(Ins::SBC_ABSY);
		mem[0xFF01] = 0x00;
		mem[0xFF02] = 0x80;
		mem[0x8000 + 0x10] = Test.Operand;
		constexpr s64 EXPECTED_CYCLES = 4;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] = 
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_ZP) : opcode(Ins::SBC_ZP);
		mem[0xFF01] = 0x42;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] =
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_ZPX) : opcode(Ins::SBC_ZPX);
		mem[0xFF01] = 0x42;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] =
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_INDX) : opcode(Ins::SBC_INDX);
		mem[0xFF01] = 0x02;
		...
		EOperation Operation = EOperation::Add )
	{
		...
		mem[0xFF00] =
			(Operation == EOperation::Add) ?
			opcode(Ins::ADC_INDY) : opcode(Ins::SBC_INDY);
		mem[0xFF01] = 0x02;
		mem[0x0002] = 0x00;
		mem[0x0003] = 0x80;
